...
def Quadra():
	...
	Cena_Campo.vai()
	Elemento_Dogin=Elemento(img=Dogin, tit="DOGIN1",style=dict(left=100, top=500, width="120px",height="20px"))   
	...
	Elemento_Pombo=Elemento(img=Pombo, tit="POMBO1",style=dict(left=600, top=200, width="190px",height="300px"))       
