...
Exception: <TypeError: Cannot read property '$nat' of undefined>
'''},
{'date': 'Thu Nov 05 2020 20:13:10.453 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
Exception: <Error: Property 'color' must be a vector.>
'''},
{'date': 'Thu Nov 05 2020 20:43:34.396 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
Exception: <SyntaxError: Unexpected token ','>
'''},
...
KeyError: 0
'''},
{'date': 'Sat Nov 07 2020 17:10:38.489 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
KeyError: 64
'''},
{'date': 'Sat Nov 07 2020 17:12:19.732 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 142
    self.casas()
  module <module> line 164
    [Cubo(2, y, z, self.calcula_propriedade_peca(tipo+21))
  module <module> line 56
    forma, gran, peq, des = FORMAS[tipo >> 6]
KeyError: 64
'''},
{'date': 'Sat Nov 07 2020 17:23:03.555 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
KeyError: 64
'''},
{'date': 'Sat Nov 07 2020 17:28:04.866 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
KeyError: 1024
'''},
{'date': 'Sat Nov 07 2020 17:32:26.35 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
Exception: <Error: Property 'color' must be a vector.>
'''},
{'date': 'Sat Nov 07 2020 17:46:07.239 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
Exception: <Error: Property 'color' must be a vector.>
'''},
{'date': 'Sat Nov 07 2020 17:59:59.366 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
Exception: <SyntaxError: missing ] in computed property name>
'''},