...
'''},
{'date': 'Tue Nov 19 2019 11:21:06.376 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
SyntaxError: invalid syntax
'''},
{'date': 'Tue Dec 03 2019 09:25:26.233 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 11
  Elemento_Battle=Elemento(img=Battle, tit="BATTLE1",style=dict(left=300, top=500, width="126" height="26"))
                                                                                                ^
SyntaxError: invalid syntax
'''},
{'date': 'Sat Aug 01 2020 23:09:41.403 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 11
  Elemento_Battle=Elemento(img=Battle, tit="BATTLE1",style=dict(left=300, top=500, width="126" height="26"))
                                                                                                ^
