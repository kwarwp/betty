...
def foto1():
	...
	elementobarco=Elemento(img=barco,style=dict (top=400,left=300,width="350px",heigth="400px"))
	elementobarco.entra(cenapraia)
	elementobolsonaro=Elemento(img=bolsonaro,style=dict (top=330,left=500,width="130px",heigth="8000px"))
